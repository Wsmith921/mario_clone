...
class Pow(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.images2 = []
        self.ground = Ground()
        self.image1 = pygame.image.load("platform-q.png").convert()
        self.image2 = pygame.image.load("platform-q1.png").convert()
        self.image3 = pygame.image.load("platform-q2.png").convert()
        self.image4 = pygame.image.load("platform-q3.png").convert()
