...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.images = []
        stand = pygame.image.load("sprite_0.png").convert_alpha()
        stand = pygame.transform.scale(stand, (ground.width,ground.height))
        image1 = pygame.image.load("sprite_1.png").convert_alpha()
        image1 = pygame.transform.scale(image1, (ground.width,ground.height))
        image2 = pygame.image.load("sprite_2.png").convert_alpha()
        image2 = pygame.transform.scale(image2, (ground.width,ground.height))
        image3 = pygame.image.load("sprite_3.png").convert_alpha()
        image3 = pygame.transform.scale(image3, (ground.width,ground.height))
        image4 = pygame.image.load("sprite_4.png").convert_alpha()
...
class Bricks(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("platform-brick.png")
        self.ground = Ground()
...
class Goombas(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.ground = Ground()
        self.images = []
        self.stomp = pygame.image.load("slub3.png").convert_alpha()
        self.stomp = pygame.transform.scale(self.stomp, (self.ground.width,self.ground.height))
        self.image1 = pygame.image.load("slub1.png").convert_alpha()
        self.image1 = pygame.transform.scale(self.image1, (self.ground.width,self.ground.height))
        self.image2 = pygame.image.load("slub2.png").convert_alpha()
        self.image2 = pygame.transform.scale(self.image2, (self.ground.width,self.ground.height))
        self.images.append(self.image1)
        self.images.append(self.image2)
        self.time = 0
...
class Koopas(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.ground = Ground()
        self.images = []
        self.shell = pygame.image.load("monster3.png").convert_alpha()
        self.shell = pygame.transform.scale(self.shell, (self.ground.width,self.ground.height))

        self.image1 = pygame.image.load("monster1.png").convert_alpha()
        self.image1 = pygame.transform.scale(self.image1, (self.ground.width,self.ground.height))
        self.image2 = pygame.image.load("monster2.png").convert_alpha()
        self.image2 = pygame.transform.scale(self.image2, (self.ground.width,self.ground.height))
        self.images.append(self.image1)
        self.images.append(self.image2)
